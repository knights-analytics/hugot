...
func NewZeroShotClassificationPipeline(config pipelines.PipelineConfig[*ZeroShotClassificationPipeline], s *options.Options) (*ZeroShotClassificationPipeline, error) {
