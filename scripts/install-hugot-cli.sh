...
curl -L https://github.com/knights-analytics/hugot/releases/latest/download/onnxruntime-linux-x64.so -o "$onnxruntime_path"
curl -L https://github.com/knights-analytics/hugot/releases/latest/download/hugot-cli-linux-x64 -o "$hugot_path"
chmod +x "$hugot_path"
